...
/**
 * Algorithm for finding cycles of size K in directed graphs UAlbany CSI 660
 * 2013
 * 
...
public class Cyclotron {
    ...
    /**
     * Checks if cycle or its variation is in stack already ( cycles 1-2-3-1,
     * 3-1-2-3 and 2-3-1-2 are the same and we want only one of them )
     * 
     * @return boolean
     */
